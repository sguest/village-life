...
/*
    This is a re-implementation/copy of net.minecraft.item.crafting.SingleItemRecipe used by base MC recipes like the Stonecutter
    That class cannot be extended due to the access level of some items within the class
    Relevant github issue was closed with only comment suggesting use of access transformer
    https://github.com/MinecraftForge/MinecraftForge/issues/6105
    Copying class seems like a better solution than implementing an access transformet
*/
