...
public class ModMemoryModuleType {
    ...
    public static final RegistryObject<MemoryModuleType<BlockPos>> NEAREST_TRADING_POST = MEMORY_MODULE_TYPES.register("nearest_trading_post", () -> new MemoryModuleType<>(Optional.empty()));
